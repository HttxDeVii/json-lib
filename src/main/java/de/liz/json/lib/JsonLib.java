package de.liz.json.lib;

import com.google.gson.*;
import de.liz.json.lib.serializer.JsonLibSerializer;
...
public class JsonLib {
    ...
    protected static final Gson gson = new GsonBuilder().registerTypeAdapter(JsonLib.class, new JsonLibSerializer()).setPrettyPrinting().serializeNulls().create();
    ...
    public void append(String property, String value){
        if(!(jsonElement instanceof JsonObject)) throw new UnsupportedOperationException("Can't append element to JsonPrimitive.");
    ...
    public Integer getInt(String property){
        if(!(jsonElement instanceof JsonObject)) throw new UnsupportedOperationException("Can't get element from JsonPrimitive.");
    ...
    public Set<Map.Entry<String, JsonElement>> getEntrySet(){
        ...
        if(!(jsonElement instanceof JsonObject)) throw new UnsupportedOperationException("Can't get keys from JsonPrimitive.");
    ...
    protected static String loadFromInputStream(InputStream inputStream){
        try{
            byte[] data = new ByteArrayOutputStream(inputStream.available()).toByteArray();
